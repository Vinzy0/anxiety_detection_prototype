...
class BodyDetector:
    ...
    def compute_bpm(self):
        ...
        peaks, _ = find_peaks(signal, distance=min_distance, prominence=0.002) # Finds peaks (inhales) in the shoulder movement signal. Prominence = filters out small peaks
